...
final Command<ApplicationContext> cdCommand = buildCommand(
  docs: const CommandDocs(
    ...
    fullDescription: 'Launch a child shell rooted at the local sync directory. Like chezmoi cd, this opens a new shell session instead of changing the current directory of your existing shell.',
  ),
